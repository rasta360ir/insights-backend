...
return [
    ...
    */
    ...
    'confirmed' => 'تکرار گزینه :attribute صحیح نمی باشد',
    'current_password' => 'گذرواژه صحیح نمی باشد',
    ...
    'password' => 'گذرواژه صحیح نمی باشد',
    ...
    */
    ...
    'attributes' => [
        ...
        'slug' => 'نامک',
        'official_title' => 'عنوان رسمی/ثبتی',
        'status' => 'وضعیت',
        'business_model' => 'نوع تجارت',
        'image_url' => 'تصویر',
        'province_id' => 'استان',
        'city_id' => 'شهر',
        'register_year' => 'سال ثبت',
        'register_month' => 'ماه ثبت',
        'register_day' => 'روز ثبت',
        'start_year' => 'سال شروع',
        'start_month' => 'ماه شروع',
        'start_day' => 'روز شروع',
        'g-recaptcha-response' => '`من ربات نیستم`',
        'robot-detected' => '`من ربات نیستم`',
